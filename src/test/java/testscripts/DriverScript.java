...
public class DriverScript {
	public static String userName = "priyadarshanm"; //Enter your LT Username here
	public static String accessKey = "vW3veYakN6TgHbB2YWsUJkFHf6D8I9E0jt9BddJAHWhVYk75bW";
